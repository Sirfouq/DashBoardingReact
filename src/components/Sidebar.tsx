    ...
    <aside className="h-screen">
      <nav className="h-full flex flex-col bg-indigo-50 border-r shadow-sm">
        ...
        <div style={{
          ...
          border: '1px solid #ddd', // Basic styling, customize as needed
          boxShadow: '0px 2px 5px rgba(0,0,0,0.2)', // Basic drop shadow, customize as needed
          backgroundColor: 'white', // Basic background, customize as needed
          borderRadius: '4px', // Rounded corners, customize as needed
          padding: '10px', // Inner spacing, customize as needed
        }}>
          {/* Menu items */}
          <div>Menu Item 1</div>
          <div>Menu Item 2</div>
